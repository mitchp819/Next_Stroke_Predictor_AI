...
class img_processer:
    ...
    def compare_img_with_dataset(self, input_image):
        ...
        print("\n---------------- 4x4 ---------------")
        index_list4 = self.find_similar(downscaled4, self.data_set_4, None, .2, .00001)
        ...
        print("\n---------------- 8x8 ---------------")
        index_list8 = self.find_similar(downscaled8, self.data_set_8, index_list4, .2, 0) 
        ...
        print("\n---------------- 16x16 ---------------")
        index_list16 = self.find_similar(downscaled16, self.data_set_16, index_list8, .3, 0)
        ...
        print("\n---------------- 32x32 ---------------")
        index_list32 = self.find_similar(downscaled32, self.data_set_32, index_list16, .4, 0)
        ...
        print("\n---------------- 64x64 ---------------")
        index_list64 = self.find_similar(downscaled64, self.data_set_64, index_list32, .5, 0)
        ...
        print("\n---------------- 126x128 ---------------")
        index_list128 = self.find_similar(input_image, self.data_set, index_list64, .6, 0)
